#!/usr/bin/env bash
# check_placeholders.sh -- run immediately before resubmission.
# Exits non-zero if the manuscript still contains an unfilled placeholder,
# an unresolved cross-reference, or an undefined citation.
#
# Usage:  ./check_placeholders.sh article_06082026.tex
set -uo pipefail
